        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default" style="width:50%; margin:0 auto;">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" 
                        action="{{ route('product.payment') }}" method="post" class="validation"
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-12  col-md-6 form-group card required' >
                                ...
                                <label class='control-label'>Amount(INR)</label> <input
                                    autocomplete='off' class='form-control card-num' size='20'
                        ...
                        <div class='form-row row'>
                            ...
                            <div class='col-xs-12 col-md-6 form-group expiration required'>
                                <label style="padding-bottom: 20px;" class='control-label'>Expiration Year</label> <input
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <button class="btn btn-success btn-lg btn-block" type="submit" style="padding:6px; font-size:16px;">Pay Now</button>
                            </div>
                        </div>
